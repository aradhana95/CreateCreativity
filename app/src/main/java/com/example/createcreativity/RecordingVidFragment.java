 ...
 */
public class RecordingVidFragment extends Fragment {
    @BindView(R.id.camera_view)
    CameraView cameraView;
    @BindView(R.id.vid_rec_btn)
    Button VidRecBtn;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        VidRecBtn.setOnClickListener(v -> {initCamera();});
    ...
    public  void initCamera(){
        ...
        { cameraView.startRecording(vidioFile, null, new VideoCapture.OnVideoSavedCallback() {

            @Override
            public void onVideoSaved(@NonNull File file) {
                Toast.makeText(getActivity(), "vidio has been saved to" + file, Toast.LENGTH_SHORT).show();
            ...
            requestPermissions( new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 21);
